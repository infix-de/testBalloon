...
* [Using TestBalloon for a **Kotlin Multiplatform project with an Android app**](https://github.com/infix-de/testBalloon/tree/main/examples/multiplatform-with-android/build.gradle.kts), containing
    * local tests (a.k.a. host-based tests, unit tests),
    * device tests (a.k.a. instrumented tests).
