...
open class CompilerPluginBaseTests(addExternalEntryPointSourceFile: Boolean = false) {
    private val externalEntryPointSourceFile = if (addExternalEntryPointSourceFile) {
