...
class IrGenerationExtensionBase(
    ...
    private val declarationFinder: (IrPluginContext) -> DeclarationFinderBridge,
...
abstract class ModuleTransformer(val configuration: Configuration) :
    ...
    class Configuration(
        ...
        override val declarationFinder: DeclarationFinderBridge,
    ...
    override val declarationFinder: DeclarationFinderBridge = configuration.declarationFinder
...
/**
 * Bridge to the `DeclarationFinder` interface introduced in Kotlin 2.3.20.
 */
interface DeclarationFinderBridge {
...
private interface ModuleWideSymbolResolving : Reporting {
    val declarationFinder: DeclarationFinderBridge
