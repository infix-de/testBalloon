...
import de.infix.testBalloon.framework.core.internal.integration.TestSessionRelay.resultChannel
...
internal fun TestElement.registerWithKotlinJsTestFramework() {
    ...
    when (this) {
        ...
        is Test -> {
            kotlinJsTestFramework.test(reportingNameForJsAndTeamCity, ignored = !testElementIsEnabled) {
