...
private fun Project.wireEntryPointTaskToAndroidSourceSetsIfPresent(
    generateTestBalloonEntryPointTask: TaskProvider<GenerateTestBalloonEntryPointTask>,
    debugLog: (message: String) -> Unit
) {
