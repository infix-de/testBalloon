...
class TestBalloonGradlePlugin : KotlinCompilerPluginSupportPlugin {
    ...
    private lateinit var extension: TestBalloonGradleExtension
    private val displayName = "Plugin $PROJECT_COMPILER_PLUGIN_ID"
    ...
    override fun isApplicable(kotlinCompilation: KotlinCompilation<*>): Boolean {
        ...
        return testBalloonProperties.isTestSourceSet(
            ...
            if (!applies && extension.debugLevel > DebugLevel.NONE) {
                project.logger.warn(
                    "$displayName: [DEBUG] compiler plugin is not applicable" +
     ...
     */
    private fun Project.addEntryPointSourceFileIfNecessary() {
